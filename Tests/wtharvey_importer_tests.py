...
from Application.wtharvey_importer import WTHarveyImporter
...
class HarveyImporterTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.importer = WTHarveyImporter()
        db.create_all()
    ...
    def testReadOneEntry(self):
        ...
        result_list = self.importer.import_from_file('Test_Resources/one_entry.txt')
    ...
    def testReadSevenEntries_ReturnsCorrectFifthEntry(self):
        ...
        result_list = self.importer.import_from_file('Test_Resources/m8n2.txt')
